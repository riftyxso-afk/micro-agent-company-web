...
export default function HiringBanner() {
  return (
    <section aria-label="We are hiring" className="relative bg-white border-b border-stone-100">
        ...
        <div className="relative px-6 sm:px-10 lg:px-14 py-14 lg:py-16 flex flex-col justify-center">
          ...
          <div className="relative z-10 max-w-[480px]">
            ...
            <p className="text-stone-500 text-[14px] sm:text-[15px] leading-relaxed">
              We&apos;re building AI agents that handle real work for real
              businesses. Join us if you want to build the tools that run
              someone&apos;s business.
            </p>
          </div>
        </div>
        ...
        <div className="relative min-h-[40vh] lg:min-h-full bg-stone-100 overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-10">
            <div className="text-center">
              ...
              <p className="text-stone-400 text-[12px] font-medium">Team photo coming soon</p>
            </div>
          </div>
        </div>
      </div>
