...
export async function POST(request: NextRequest) {
  try {
    ...
    const successRedirect = `${process.env.NEXT_PUBLIC_BASE_URL || "https://www.themicroagentcompany.biz.id"}/products/microclaw/payment/provisioning?order_id=${order_id}`;
